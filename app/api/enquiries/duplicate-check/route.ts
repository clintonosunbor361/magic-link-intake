...
import { createEnquiryRepository } from "@/lib/enquiries/repository";
...
export async function POST(request: Request) {
  ...
  const candidates = await createEnquiryRepository().getDuplicateCandidates(session.organizationId);
