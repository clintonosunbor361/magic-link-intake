...
export default function CrmError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-xl border-y border-kuartz-line py-12">
      <p className="eyebrow">Workspace interrupted</p>
      <h1 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-kuartz-ink">This view could not be loaded.</h1>
