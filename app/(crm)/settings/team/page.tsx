...
export default async function TeamPage({ searchParams }: { searchParams: Promise<{ error?: string; invited?: string }> }) {
  ...
  return (
    <div>
      ...
      <nav className="mt-6 flex gap-4 text-sm font-semibold"><Link href="/settings/team" className="text-[#171b36] underline">Team</Link><Link href="/settings/item-types" className="text-[#50586c] hover:text-[#171b36]">Item types</Link><Link href="/settings/consultation-note-sources" className="text-[#50586c] hover:text-[#171b36]">Consultation note sources</Link><Link href="/settings/measurement-fields" className="text-[#50586c] hover:text-[#171b36]">Measurement fields</Link><Link href="/settings/measurement-requirements" className="text-[#50586c] hover:text-[#171b36]">Measurement requirements</Link></nav>
