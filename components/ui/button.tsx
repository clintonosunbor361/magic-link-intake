...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[0.5rem] text-sm font-extrabold transition-[background,color,border-color,box-shadow] duration-150 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-kuartz-lime/30 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
