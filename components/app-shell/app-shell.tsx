    ...
    <div className="min-h-[100dvh] bg-[#f4f3ee] lg:pl-[17rem]">
      ...
      <header className="sticky top-0 z-20 flex h-[4.5rem] items-center justify-between border-b border-[#d9d8d1] bg-[#f4f3ee]/90 px-4 backdrop-blur-xl sm:px-7 lg:px-10">
        <div className="pl-12 lg:pl-0">
          ...
          <p className="text-xs text-[#50586c]">Operations workspace</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="hidden text-right sm:block"><p className="text-sm font-semibold text-[#171b36]">{session.fullName}</p><p className="text-xs text-[#50586c]">{session.role === "super_admin" ? "Super Admin" : "Admin Assistant"}</p></div>
